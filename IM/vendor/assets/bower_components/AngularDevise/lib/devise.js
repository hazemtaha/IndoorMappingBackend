(function(angular) {
     ...
     */
    var paths = {
        login: '/owners/sign_in.json',
        logout: '/owners/sign_out.json',
        register: '/owners.json',
        sendResetPasswordInstructions: '/owners/password.json',
        resetPassword: '/owners/password.json'
    };
